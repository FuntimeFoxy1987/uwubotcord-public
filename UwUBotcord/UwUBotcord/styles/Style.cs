...
namespace UwUBotcord.styles
{
    ...
    static class ButtonExtensions
    {
        ...
        public static SolidColorBrush GetColorClick(DependencyObject obj)
        {
            return (SolidColorBrush)obj.GetValue(ColorClickProperty);
        }
        public static void SetColorClick(DependencyObject obj, SolidColorBrush value)
        {
            obj.SetValue(ColorClickProperty, value);
        }

        public static readonly DependencyProperty ImageProperty =
            DependencyProperty.RegisterAttached( 
                "Image", typeof(ImageSource), typeof(ButtonExtensions));
        public static readonly DependencyProperty ColorClickProperty =
            DependencyProperty.RegisterAttached(
                "ColorClick", typeof(SolidColorBrush), typeof(ButtonExtensions));
    }
    ...
    public partial class Style
    {
        ...
        void InMouseOverIcon(object sender, RoutedEventArgs e)
        {
            ///
        }
    }
